...
cercle4.style.top = Math.floor(Math.random() * 100)+'%';
cercle4.style.left = Math.floor(Math.random() * 100)+'%';

cercle5.style.top = Math.floor(Math.random() * 100)+'%';
cercle5.style.left = Math.floor(Math.random() * 100)+'%';

cercle6.style.top = Math.floor(Math.random() * 100)+'%';
